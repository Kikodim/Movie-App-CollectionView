...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CollectionView Movies App.Android.dll" comes first in this list. */
		"CollectionView Movies App.Android.dll",
		"CollectionView Movies App.dll",
		"FormsViewGroup.dll",
